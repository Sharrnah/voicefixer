...
def save_wave(frames: np.ndarray, fname, sample_rate=44100, format='WAV', subtype='PCM_16'):
    ...
    if (len(frames.shape) >= 3):
        frames = frames[0,...]
    sf.write(fname,frames,samplerate=sample_rate,format=format,subtype=subtype)
